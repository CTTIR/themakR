...
2.  Edit the payload under `inst/pkgdown/` (shared config, templates,
    SCSS).
...
Style fixes should go through bslib variables or
`inst/pkgdown/extra.scss` — please don’t hardcode per-package values
